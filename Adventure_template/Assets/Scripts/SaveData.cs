...
public class SaveData : ResettableScriptableObject
{
    ...
    public KeyValuePairLists<List<Item>> itemsKeyValuePairLists = new KeyValuePairLists<List<Item>>();
    //items in inventory
    public KeyValuePairLists<List<GameObject>> itemPrefabsKeyValuePairLists = new KeyValuePairLists<List<GameObject>>();
    public override void Reset()
    {
        ...
        itemsKeyValuePairLists.Clear();
        itemPrefabsKeyValuePairLists.Clear();
    }
    ...
    {
        Save(itemsKeyValuePairLists, key, value);
    }
    public void Save(string key, List<GameObject> value)
    {
        Save(itemPrefabsKeyValuePairLists, key, value);
    }
    ...
    {
        return Load(itemsKeyValuePairLists, key, ref value);
    }
    public bool Load(string key, ref List<GameObject> value)
    {
        return Load(itemPrefabsKeyValuePairLists, key, ref value);
    }
}
